...
import { Database, MapPinned, MonitorCog, Shield } from "lucide-react"

export type SettingsTabId = "blacklist" | "sources" | "browser" | "database"
...
const TABS = [
  ...
  { id: "browser", label: "Браузер", icon: MonitorCog },
